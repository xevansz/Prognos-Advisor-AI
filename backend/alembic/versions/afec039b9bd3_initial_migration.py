...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_prognosis_reports_generated_at"),
        "prognosis_reports",
        ["generated_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_prognosis_reports_user_id"),
        "prognosis_reports",
        ["user_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "frequency",
            sa.Enum("MONTHLY", name="recurrencefrequency", native_enum=False, length=20),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("DEBIT", "CREDIT", name="transactiontype", native_enum=False, length=10),
            nullable=False,
        ),
        sa.Column("currency", sa.String(length=3), nullable=False),
